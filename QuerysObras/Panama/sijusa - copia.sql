...
-- SELECT Obra, Descripcion, Gratis, Publico, Activa, CodListaPaises, CodTema, OrderInfo, path, dominio, Vista, GrupoTema FROM dbo.Infobases WHERE CodListaPaises =6 ;


--SELECT distinct  CodTema FROM dbo.Infobases  WHERE CodListaPaises =6 ;
...
TEMA_DERECHO COMERCIAL Y SOCIETARIO
