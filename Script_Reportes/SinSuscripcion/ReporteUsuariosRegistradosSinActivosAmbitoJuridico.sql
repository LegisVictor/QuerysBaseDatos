...
where  uc.FechaCreacion >'2022-01-01 00:00' and Cliente='AmbitoJuridico'
...
where  uc.FechaCreacion >'2020-01-01 00:00' and Cliente='AmbitoJuridico' and s.Sil_CodSuscripcion is not null  and s.FechaFin>getdate() and ac.CodAplicacionWeb in (12)
)
