...
where  uc.FechaCreacion between '2025-12-05 00:00' and '2026-02-24 00:00'   and Cliente='SilvIA'
...
where  uc.FechaCreacion >'2020-01-01 00:00' and Cliente='SilvIA'
and s.Sil_CodSuscripcion is not null  
and s.FechaFin>getdate() and ac.CodAplicacionWeb in (41))
