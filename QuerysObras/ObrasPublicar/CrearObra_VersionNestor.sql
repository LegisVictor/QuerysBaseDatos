...
FROM dbo.Infobases
WHERE obra in ('comerbasico2022b','comerbasico2022a') 
...
SET @ObraOriginal = LOWER('comerbasico2022a');
SET @ObraNueva = LOWER('comerbasico2022b');
SET @ObraDescripcion = 'CÓDIGO DE COMERCIO BASICO 476A ED';
SET @ObraTemaPais = 'CODIGOS BASICOS 2022';
SET @ObraTemaTema = 'TEMA_DERECHO COMERCIAL Y SOCIETARIO';
