...
SET @ObraOriginal = LOWER('penalbasicoested11');
SET @ObraNueva = LOWER('penalbasicoested13');
SET @ObraDescripcion = 'CÓDIGO PENAL Y DE PROCEDIMIENTO PENAL BÁSICO - COLECCIÓN UNIVERSITARIA 13a ed';
SET @ObraTemaPais = 'COLECCION UNIVERSITARIA';
SET @ObraTemaTema = 'TEMA_DERECHO ADMINISTRATIVO';
