...
SET @ObraOriginal = LOWER('comerbasicoested11');
SET @ObraNueva = LOWER('comerbasicoested13');
SET @ObraDescripcion = 'CÓDIGO DE COMERCIO BÁSICO - COLECCIÓN UNIVERSITARIA 13a ed';
