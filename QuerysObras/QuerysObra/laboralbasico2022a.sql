...
SET @ObraOriginal = LOWER('laboralbasico2021b');
SET @ObraNueva = LOWER('laboralbasico2022a');
SET @ObraDescripcion = 'CÓDIGO SUSTANTIVO DEL TRABAJO BASICO 48A ED';
SET @ObraTemaPais = 'CODIGOS BASICOS 2022';
SET @ObraTemaTema = 'TEMA_DERECHO LABORAL Y SEGURIDAD SOCIAL';
