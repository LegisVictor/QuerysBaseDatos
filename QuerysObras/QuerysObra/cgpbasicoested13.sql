...
SET @ObraOriginal = LOWER('cgpbasicoested12');
SET @ObraNueva = LOWER('cgpbasicoested13');
SET @ObraDescripcion = 'CÓDIGO GENERAL DEL PROCESO - COLECCIÓN UNIVERSITARIA 13a ed';
