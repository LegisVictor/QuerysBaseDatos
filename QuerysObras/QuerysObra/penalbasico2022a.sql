...
SET @ObraOriginal = LOWER('penalbasico2021b');
SET @ObraNueva = LOWER('penalbasico2022a');
SET @ObraDescripcion = 'CÓDIGO PENAL BASICO - 27A ED';
SET @ObraTemaPais = 'CODIGOS BASICOS 2022';
SET @ObraTemaTema = 'TEMA_DERECHO PENAL';
