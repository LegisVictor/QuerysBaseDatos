...
where  uc.FechaCreacion between '2024-06-01 00:00' and '2025-04-01 00:00'  and Cliente='LegisComex'
...
where  uc.FechaCreacion >'2020-01-01 00:00' and Cliente='LegisComex' and s.Sil_CodSuscripcion is not null  and s.FechaFin>getdate() and ac.CodAplicacionWeb in (33)
)
...
(
select REPLACE(USER_ID,'f:bd03591f-be73-4be4-b7ed-a7c264d01cd9:','') as Usuario, FechaCreacion, FIRST_NAME as Nombre, LAST_NAME as Apellido, EMAIL as Correo, 
		mobile as Telefono, gender as Sexo, address as Direccion, birthdate as Nacimiento,especializations as Especializaciones, interests as Intereses, 
		occupation as Ocupacion,companysize as Empresa, sector as Sector,region as Region, habeas as HabeasSSO
FROM(
...
From (
	...
	where th.sitio LIKE '%LegisComex%'
	) sub
Where rn=1
