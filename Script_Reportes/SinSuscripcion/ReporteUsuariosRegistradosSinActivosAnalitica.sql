...
where  uc.FechaCreacion >'2020-01-01 00:00' and Cliente='Analitica'
...
where  uc.FechaCreacion >'2020-01-01 00:00' and Cliente='Analitica' and s.Sil_CodSuscripcion is not null  and s.FechaFin>getdate() and ac.CodAplicacionWeb in (34)
)
