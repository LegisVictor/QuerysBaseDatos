...
where  uc.FechaCreacion between '2024-06-01 00:00' and '2025-04-20 00:00' and Cliente='Construdata'
...
where  uc.FechaCreacion >'2020-01-01 00:00' and Cliente='Construdata' and s.Sil_CodSuscripcion is not null  and s.FechaFin>getdate() and ac.CodAplicacionWeb in (40)
)
...
From (
	...
	from [10.250.4.7].[habeasdata].[dbo].TblAutorizacion th 
	where th.sitio = 'Construdata' or th.sitio = 'Construdata'
) sub
Where rn=1
